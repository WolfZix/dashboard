...
export async function getDashboardData(): Promise<DashboardData> {
  return {
    ...
    chart: [
      { name: "M1", revenue: 0 },
      { name: "M2", revenue: 19625 },
      { name: "M3", revenue: 9812 },
      { name: "M4", revenue: 29437 },
      { name: "M5", revenue: 9812 },
      { name: "M6", revenue: 39250 },
      { name: "M7", revenue: 29437 },
      { name: "M8", revenue: 58875 },
      { name: "M9", revenue: 19625 },
      { name: "M10", revenue: 39250 },
      { name: "M11", revenue: 9812 },
      { name: "M12", revenue: 29437 },
      { name: "M13", revenue: 9812 },
      { name: "M14", revenue: 29437 },
      { name: "M15", revenue: 19625 },
      { name: "M16", revenue: 29437 },
      { name: "M17", revenue: 19625 },
      { name: "M18", revenue: 29437 },
      { name: "M19", revenue: 19625 },
      { name: "M20", revenue: 39250 },
      { name: "M21", revenue: 9812 },
      { name: "M22", revenue: 49062 },
      { name: "M23", revenue: 29437 },
      { name: "M24", revenue: 39250 },
      { name: "M25", revenue: 29437 },
      { name: "M26", revenue: 49062 },
      { name: "M27", revenue: 19625 },
      { name: "M28", revenue: 39250 },
      { name: "M29", revenue: 9812 },
      { name: "M30", revenue: 29437 },
      { name: "M31", revenue: 9812 },
      { name: "M32", revenue: 19625 },
      { name: "M33", revenue: 9812 },
      { name: "M34", revenue: 19625 },
      { name: "M35", revenue: 9812 },
      { name: "M36", revenue: 39250 },
      { name: "M37", revenue: 19625 },
      { name: "M38", revenue: 49062 },
      { name: "M39", revenue: 29437 },
      { name: "M40", revenue: 49062 },
      { name: "M41", revenue: 29437 },
      { name: "M42", revenue: 68687 },
      { name: "M43", revenue: 39250 },
      { name: "M44", revenue: 68687 },
      { name: "M45", revenue: 39250 },
      { name: "M46", revenue: 58875 },
      { name: "M47", revenue: 49062 },
      { name: "M48", revenue: 58875 },
      { name: "M49", revenue: 29437 },
      { name: "M50", revenue: 78500 },
    ],
    notifications: [
      {
        from: "System",
        ...
        date: "2 min ago",
        description:
          "The scheduled infrastructure maintenance has been completed successfully without any downtime.",
      },
      {
        from: "Finance Team",
        ...
        date: "12 min ago",
        description:
          "Revenue for this month exceeded projections by 8.4% compared to the previous period.",
      },
      {
        ...
        date: "18 min ago",
        description:
          "A new login was detected from a previously unknown device located in Berlin, Germany.",
      },
      {
        from: "Analytics",
        ...
        date: "24 min ago",
        description:
          "Website traffic increased significantly after the latest marketing campaign launch.",
      },
      {
        from: "Support",
        ...
        date: "31 min ago",
        description:
          "A high-priority customer issue has been assigned to your support queue.",
      },
      {
        from: "Database",
        ...
        date: "45 min ago",
        description:
          "Database indexing and cleanup tasks finished successfully with improved query performance.",
      },
      {
        from: "Marketing",
        ...
        date: "1 hour ago",
        description:
          "The latest social campaign reached over 14,000 users across multiple platforms.",
      },
      {
        from: "Workspace",
        ...
        date: "1 hour ago",
        description:
          "Emily Johnson joined the workspace and received administrator permissions.",
      },
      {
        from: "Billing",
        ...
        date: "2 hours ago",
        description:
          "Your Professional plan subscription has been renewed successfully for another month.",
      },
      {
        from: "Cloud Storage",
        ...
        date: "2 hours ago",
        description:
          "Cloud storage usage has reached 82% of the available workspace capacity.",
      },
      {
        from: "AI Assistant",
        ...
        date: "3 hours ago",
        description:
          "AI-generated business insights are now available in the analytics dashboard.",
      },
      {
        from: "API Gateway",
        ...
        date: "4 hours ago",
        description:
          "Average API response time decreased by 16% after the latest deployment.",
      },
      {
        from: "Moderation",
        ...
        date: "5 hours ago",
        description:
          "There are currently 12 comments pending moderation approval in the community section.",
      },
      {
        from: "Mobile App",
        ...
        date: "6 hours ago",
        description:
          "The newest mobile application update is now available for iOS and Android devices.",
      },
      {
        from: "Monitoring",
        ...
        date: "8 hours ago",
        description:
          "Infrastructure monitoring confirms that all services are running normally with no incidents detected.",
      },
    ],
    profileOptions: [
      { name: "Profile", icon: "user", path: "/profile", shortcut: "Alt+P" },
      {
        name: "Settings",
        icon: "settings",
        path: "/settings",
      ...
      { name: "Log Out", icon: "logout", path: "login", shortcut: "Alt+L" },
    ],
    usersData,
