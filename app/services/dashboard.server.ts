export async function getDasboardData() {
    return {
        ...
        UsersData: [
            { id: 1, name: "WolfeZix", role: "Admin", status: "Online", joined: "05/05/2026" },
            { id: 2, name: "NovaByte", role: "Moderator", status: "Away", joined: "12/04/2026" },
            { id: 3, name: "ShadowSync", role: "User", status: "Offline", joined: "28/03/2026" },
            { id: 4, name: "PixelCrafter", role: "Premium", status: "Online", joined: "17/02/2026" },
            { id: 5, name: "EchoPulse", role: "User", status: "Busy", joined: "09/01/2026" },
            { id: 6, name: "CyberNest", role: "Moderator", status: "Online", joined: "23/11/2025" },
            { id: 7, name: "ZenithFlow", role: "User", status: "Away", joined: "30/12/2025" },
            { id: 8, name: "CodeRift", role: "Premium", status: "Offline", joined: "14/08/2025" },
            { id: 9, name: "FrostNova", role: "User", status: "Online", joined: "02/06/2025" },
            { id: 10, name: "OrbitByte", role: "User", status: "Busy", joined: "19/05/2025" },
            { id: 11, name: "HyperLeaf", role: "Premium", status: "Online", joined: "11/03/2025" },
            { id: 12, name: "NeonHive", role: "Moderator", status: "Offline", joined: "26/07/2025" },
            { id: 13, name: "SkyForge", role: "User", status: "Away", joined: "04/10/2025" },
            { id: 14, name: "DriftCode", role: "User", status: "Online", joined: "15/09/2025" },
            { id: 15, name: "PulseFrame", role: "Premium", status: "Busy", joined: "21/01/2026" },
            { id: 16, name: "QuantumEdge", role: "Admin", status: "Online", joined: "08/02/2026" },
            { id: 17, name: "LunarStack", role: "User", status: "Offline", joined: "13/11/2025" },
            { id: 18, name: "VertexGlow", role: "Premium", status: "Away", joined: "25/04/2026" },
            { id: 19, name: "AeroShift", role: "User", status: "Online", joined: "07/06/2025" },
            { id: 20, name: "CrypticFox", role: "Moderator", status: "Busy", joined: "29/12/2025" },
            { id: 21, name: "ByteHunter", role: "User", status: "Online", joined: "18/02/2026" },
            { id: 22, name: "SolarFlare", role: "Premium", status: "Away", joined: "07/01/2026" },
        ],
    };
}