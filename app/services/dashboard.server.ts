...
export async function getDasboardData(): Promise<DashboardData> {
    return {
        stats: {
            revenue: "78,500",
            users: "8,421",
        ...
        UsersData: [
            { id: 1, name: "WolfeZix", role: "Admin", status: "Online", joined: "2026-05-05", bio: "🚀 Building cool dashboard stuff", projects: 12, reports: 31, tasks: 84, commits: 621 },
            { id: 2, name: "NovaByte", role: "Moderator", status: "Away", joined: "2026-04-12", bio: "☕ Probably debugging something", projects: 9, reports: 24, tasks: 53, commits: 418 },
            { id: 3, name: "ShadowSync", role: "User", status: "Offline", joined: "2026-03-28", bio: "", projects: 2, reports: 3, tasks: 12, commits: 41 },
            { id: 4, name: "PixelCrafter", role: "Premium", status: "Online", joined: "2026-02-17", bio: "🎨 UI perfectionist", projects: 18, reports: 42, tasks: 91, commits: 802 },
            { id: 5, name: "EchoPulse", role: "User", status: "Busy", joined: "2026-01-09", bio: "🎧 Coding with synthwave", projects: 7, reports: 11, tasks: 37, commits: 259 },
            { id: 6, name: "CyberNest", role: "Moderator", status: "Online", joined: "2025-11-23", bio: "", projects: 14, reports: 39, tasks: 78, commits: 711 },
            { id: 7, name: "ZenithFlow", role: "User", status: "Away", joined: "2025-12-30", bio: "🌙 Night owl developer", projects: 5, reports: 7, tasks: 26, commits: 194 },
            { id: 8, name: "CodeRift", role: "Premium", status: "Offline", joined: "2025-08-14", bio: "", projects: 16, reports: 47, tasks: 109, commits: 920 },
            { id: 9, name: "FrostNova", role: "User", status: "Online", joined: "2025-06-02", bio: "❄️ Keeping things cool", projects: 4, reports: 9, tasks: 21, commits: 136 },
            { id: 10, name: "OrbitByte", role: "User", status: "Busy", joined: "2025-05-19", bio: "", projects: 3, reports: 5, tasks: 18, commits: 82 },
            { id: 11, name: "HyperLeaf", role: "Premium", status: "Online", joined: "2025-03-11", bio: "🌿 Touching grass occasionally", projects: 20, reports: 55, tasks: 132, commits: 1104 },
            { id: 12, name: "NeonHive", role: "Moderator", status: "Offline", joined: "2025-07-26", bio: "💡 Bright ideas only", projects: 11, reports: 28, tasks: 66, commits: 487 },
            { id: 13, name: "SkyForge", role: "User", status: "Away", joined: "2025-10-04", bio: "", projects: 6, reports: 10, tasks: 29, commits: 213 },
            { id: 14, name: "DriftCode", role: "User", status: "Online", joined: "2025-09-15", bio: "🏎️ Fast code, fast life", projects: 8, reports: 15, tasks: 44, commits: 321 },
            { id: 15, name: "PulseFrame", role: "Premium", status: "Busy", joined: "2026-01-21", bio: "🎵 Vibing while coding", projects: 15, reports: 36, tasks: 88, commits: 653 },
            { id: 16, name: "QuantumEdge", role: "Admin", status: "Online", joined: "2026-02-08", bio: "⚡ Scaling the impossible", projects: 24, reports: 63, tasks: 154, commits: 1422 },
            { id: 17, name: "LunarStack", role: "User", status: "Offline", joined: "2025-11-13", bio: "", projects: 1, reports: 2, tasks: 9, commits: 28 },
            { id: 18, name: "VertexGlow", role: "Premium", status: "Away", joined: "2026-04-25", bio: "✨ Minimalism enjoyer", projects: 13, reports: 33, tasks: 71, commits: 578 },
            { id: 19, name: "AeroShift", role: "User", status: "Online", joined: "2025-06-07", bio: "🛫 Shipping features daily", projects: 10, reports: 19, tasks: 58, commits: 447 },
            { id: 20, name: "CrypticFox", role: "Moderator", status: "Busy", joined: "2025-12-29", bio: "🦊 Sneaky but productive", projects: 17, reports: 45, tasks: 117, commits: 889 },
            { id: 21, name: "ByteHunter", role: "User", status: "Online", joined: "2026-02-18", bio: "", projects: 5, reports: 8, tasks: 24, commits: 173 },
            { id: 22, name: "SolarFlare", role: "Premium", status: "Away", joined: "2026-01-07", bio: "☀️ Bright mode defender", projects: 19, reports: 51, tasks: 128, commits: 997 },
            { id: 23, name: "NightPixel", role: "Moderator", status: "Busy", joined: "2025-11-11", bio: "🌃 Working after midnight", projects: 12, reports: 30, tasks: 74, commits: 562 },
            { id: 24, name: "CoreMatrix", role: "User", status: "Offline", joined: "2025-08-22", bio: "", projects: 2, reports: 4, tasks: 11, commits: 67 },
        ],
